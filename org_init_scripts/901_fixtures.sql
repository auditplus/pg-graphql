...
('member_role__insert','{"id", "name", "perms", "ui_perms"}'),
('member_role__update','{"id", "name", "perms", "ui_perms"}'),
('approval_tag__select',null),
('approval_tag__insert','{"name", "members"}'),
('approval_tag__update','{"name", "members"}'),
('approval_tag__delete',null),
('tds_nature_of_payment__select',null),
('tds_nature_of_payment__insert','{"name", "section", "ind_huf_rate", "ind_huf_rate_wo_pan", "other_deductee_rate", "other_deductee_rate_wo_pan", "threshold"}'),
('tds_nature_of_payment__update','{"name", "section", "ind_huf_rate", "ind_huf_rate_wo_pan", "other_deductee_rate", "other_deductee_rate_wo_pan", "threshold"}'),
('tds_nature_of_payment__delete',null),
('bank_beneficiary__select',null),
('bank_beneficiary__insert','{"account_no", "bank_name", "branch_name", "ifs_code", "account_type", "account_holder_name"}'),
('bank_beneficiary__update','{"account_no", "bank_name", "branch_name", "ifs_code", "account_type", "account_holder_name"}'),
('bank_beneficiary__delete',null),
('doctor__select',null),
('doctor__insert','{"name", "license_no"}'),
('doctor__update','{"name", "license_no"}'),
('doctor__delete',null),
('stock_location__select',null),
('stock_location__insert','{"name"}'),
('stock_location__update','{"name"}'),
('stock_location__delete',null),
('display_rack__select',null),
('display_rack__insert','{"name"}'),
('display_rack__update','{"name"}'),
...
('manufacturer__insert','{"name", "mobile", "email", "telephone"}'),
('manufacturer__update','{"name", "mobile", "email", "telephone"}'),
('manufacturer__delete',null),
('sale_incharge__select',null),
('sale_incharge__insert','{"name", "code"}'),
('sale_incharge__update','{"name", "code"}'),
('sale_incharge__delete',null),
('price_list__select',null),
('price_list__insert','{"name", "customer_tag_id"}'),
('price_list__update','{"name", "customer_tag_id"}'),
('price_list__delete',null),
('price_list_condition__select',null),
('price_list_condition__insert',null),
('price_list_condition__update','{"apply_on", "computation", "priority", 
...
('print_template__insert','{"name", "config", "layout", "voucher_mode"}'),
('print_template__update','{"name", "config", "layout", "voucher_mode"}'),
('print_template__delete',null),
('gst_registration__select',null),
('gst_registration__insert','{"reg_type", "gst_no", "state_id", "username", "email", "e_invoice_username", "e_password"}'),
('gst_registration__update','{"reg_type", "gst_no", "state_id", "username", "email", "e_invoice_username", "e_password"}'),
('gst_registration__delete',null),
('account__select',null),
('account__insert','{"name", "contact_type", "account_type_id", "alias_name", "cheque_in_favour_of", "description",
...
('account__update','{"name", "alias_name", "cheque_in_favour_of", "description",
    "commission", "gst_reg_type", "gst_location_id", "gst_no", "gst_is_exempted", "gst_exempted_desc", "sac_code",
    "bill_wise_detail", "is_commission_discounted", "due_based_on", "due_days", "credit_limit", "pan_no",
    "aadhar_no", "mobile", "email", "contact_person", "address", "city", "pincode", "category1", "category2", "category3", "category4",
    "category5", "state_id", "country_id", "bank_beneficiary_id", "agent_id", "commission_account_id", "gst_tax_id",
...
('branch__select',null),
('branch__insert','{"name", "mobile", "alternate_mobile", "email", "telephone", "contact_person", "address", "city", "pincode", "state_id",
    "country_id", "gst_registration_id", "voucher_no_prefix", "misc", "members", "account_id"}'),
('branch__update','{"name", "mobile", "alternate_mobile", "email", "telephone", "contact_person", "address", "city", "pincode", "state_id",
...
('offer_management__insert','{"name", "conditions", "rewards", "branch_id", "price_list_id", "start_date", "end_date"}'),
('offer_management__update','{"name", "conditions", "rewards", "branch_id", "price_list_id", "start_date", "end_date"}'),
...
('transport__insert','{"name", "mobile", "email", "telephone"}'),
('transport__update','{"name", "mobile", "email", "telephone"}'),
('transport__delete',null),

('pos_server__select',null),
('pos_server__insert','{"name", "branch_id", "mode"}'),
('pos_server__update','{"name", "mode", "is_active"}'),
('pos_server__delete',null),

('desktop_client__select',null),
('desktop_client__insert','{"name","branches"}'),
('desktop_client__update','{"name","branches"}'),
('desktop_client__delete',null),

('unit__select',null),
('unit__insert','{"name", "uqc_id", "symbol", "precision", "conversions"}'),
('unit__update','{"name", "uqc_id", "symbol", "precision", "conversions"}'),
('unit__delete',null),
...
('category_option__insert','{"category_id", "name", "active"}'),
('category_option__update','{"category_id", "name", "active"}'),
('category_option__delete',null),

('division__select',null),
('division__insert','{"name"}'),
('division__update','{"name"}'),
('division__delete',null),

('gift_coupon__select',null),

('pos_counter__select','Select Pos Counter',null),
('pos_counter__insert','Insert Pos Counter','{"name", "branch_id"}'),
('pos_counter__update','Update Pos Counter','{"name"}'),
('pos_counter__delete','delete Pos Counter',null),
...
('voucher_type__insert','{"name", "prefix", "sequence_id", "base_type", "config", "members", "approval"}'),
('voucher_type__update','{"name", "prefix", "sequence_id", "config", "members", "approval"}'),
('voucher_type__delete',null),

('inventory__select',null),
('inventory__insert','{"name", "division_id", "inventory_type", "allow_negative_stock", "gst_tax_id", "unit_id", "loose_qty",
...
('inventory__update','{"name", "inventory_type", "allow_negative_stock", "gst_tax_id", "unit_id",
    "reorder_inventory_id", "bulk_inventory_id", "qty", "sale_unit_id", "purchase_unit_id", "cess", "purchase_config",
    "sale_config", "barcodes", "tags", "hsn_code", "description", "manufacturer_id", "manufacturer_name", "vendor_id",
    "vendor_name", "vendors", "salts", "set_rate_values_via_purchase", "apply_s_rate_from_master_for_sale",
    "category1", "category2", "category3", "category4", "category5", "category6", "category7", "category8",
...
('inventory_branch_detail__insert','{"inventory_id", "inventory_name", "branch_id", "branch_name", "stock_location_id",
...
('inventory_branch_detail__update','{"inventory_name", "branch_name", "stock_location_id",
    "s_disc", "discount_1", "discount_2", "vendor_id", "s_customer_disc", "mrp_price_list", "s_rate_price_list",
    "nlc_price_list", "mrp", "s_rate", "p_rate_tax_inc", "p_rate", "landing_cost", "nlc", "stock", "reorder_inventory_id",
    "reorder_mode", "reorder_level", "min_order", "max_order"}'),
...
('vendor_bill_map__update','{"start_row", "name", "unit", "qty", "mrp", "rate", "free", "batch_no", "expiry",
    "expiry_format", "discount"}'),
('vendor_bill_map__delete',null),

('vendor_item_map__select',null),
('vendor_item_map__insert','{"vendor_id", "inventory_id", "vendor_inventory"}'),
('vendor_item_map__update','{"vendor_inventory"}'),
...
('pharma_salt__insert','{"name", "drug_category"}'),
('pharma_salt__update','{"name", "drug_category"}'),
...
('ac_txn__select','select','{"id", "account_id", "credit", "debit", "is_default"}'),
