...
begin
    ...
    values (v_voucher.date, v_voucher.eff_date, ven.id, ven.name, v_voucher.branch_id, v_voucher.branch_name,
            ($1 ->> 'division_id')::bigint, ($1 ->> 'warehouse_id')::bigint, ($1 ->> 'amount')::float, v_voucher.id,
            v_voucher.voucher_type_id, v_voucher.base_voucher_type, v_voucher.voucher_no, v_voucher.voucher_prefix,
            v_voucher.voucher_fy, v_voucher.voucher_seq, v_voucher.ref_no, ($1 ->> 'transport_id')::bigint,
...
--##
create function update_goods_inward_note(v_id bigint, input_data json)
    returns goods_inward_note as
$$
declare
    v_voucher           voucher;
...
begin
    ...
    set date             = ($2 ->> 'date')::date,
        ...
        transport_id     = ($2 ->> 'transport_id')::bigint,
...
$$ language plpgsql;
--##
create function delete_goods_inward_note(id bigint)
    returns void as
$$
declare
    voucher_id bigint;
