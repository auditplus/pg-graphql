...
--##
alter table voucher
    add constraint voucher_pos_counter_code_fkey foreign key (pos_counter_code) references pos_counter on delete set null on update cascade;
--##
alter table batch
...
--##
alter table sale_bill
    add constraint sale_bill_pos_counter_code_fkey foreign key (pos_counter_code) references pos_counter on delete set null on update cascade;
--##
...
--##
alter table credit_note
    add constraint credit_note_pos_counter_code_fkey foreign key (pos_counter_code) references pos_counter on delete set null on update cascade;
--##
...
alter table pos_counter_transaction
    add constraint pos_counter_transaction_pos_counter_code_fkey foreign key (pos_counter_code) references pos_counter on delete cascade on update cascade;
--##
alter table pos_counter_transaction
...
--##
alter table pos_counter_transaction_breakup
    add constraint pos_counter_transaction_breakup_pos_counter_code_fkey foreign key (pos_counter_code) references pos_counter on delete cascade on update cascade;
--##
alter table pos_counter_transaction_breakup
...
--##
alter table pos_counter_session
    add constraint pos_counter_session_pos_counter_code_fkey foreign key (pos_counter_code) references pos_counter on delete cascade on update cascade;
--##
alter table pos_counter_session
