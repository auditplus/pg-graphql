create domain base_account_type as text
    check (value in ('DIRECT_INCOME', 'INDIRECT_INCOME', 'SALE', 'DIRECT_EXPENSE', 'INDIRECT_EXPENSE', 'PURCHASE', 'FIXED_ASSET',
...
(
    ...
    parent_id      bigint references account_type,
    default_name   base_account_type,
    description    text,
