...
begin
    return query
        ...
        where b.closing > 0
          ...
          and case when $1 ->> 'category1_id' is null then true else b.category1_id = ($1 ->> 'category1_id')::int end
          and case when $1 ->> 'category2_id' is null then true else b.category2_id = ($1 ->> 'category2_id')::int end
          and case when $1 ->> 'category3_id' is null then true else b.category3_id = ($1 ->> 'category3_id')::int end
          and case when $1 ->> 'category4_id' is null then true else b.category4_id = ($1 ->> 'category4_id')::int end
          and case when $1 ->> 'category5_id' is null then true else b.category5_id = ($1 ->> 'category5_id')::int end
          and case when $1 ->> 'category6_id' is null then true else b.category6_id = ($1 ->> 'category6_id')::int end
          and case when $1 ->> 'category7_id' is null then true else b.category7_id = ($1 ->> 'category7_id')::int end
          and case when $1 ->> 'category8_id' is null then true else b.category8_id = ($1 ->> 'category8_id')::int end
          and case when $1 ->> 'category9_id' is null then true else b.category9_id = ($1 ->> 'category9_id')::int end
          and case
