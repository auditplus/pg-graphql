...
begin
    insert into pos_counter_transaction (voucher_id, pos_counter_id, date, branch_id, branch_name, bill_amount,
                                         voucher_no, voucher_type_id, base_voucher_type, particular, session_id)
    values ($1.id, $1.pos_counter_id, $1.date, $1.branch_id, $1.branch_name, $1.amount, $1.voucher_no,
            $1.voucher_type_id, $1.base_voucher_type, $1.party_name, ses_id);
    foreach item in array items
        loop
            ...
            values ($1.id, acc.id, acc.name, item.credit, item.debit);
        end loop;
    return true;
end;
