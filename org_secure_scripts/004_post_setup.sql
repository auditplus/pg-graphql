...
begin
    ...
    commission, gst_reg_type, gst_location, gst_no, gst_is_exempted, gst_exempted_desc, sac_code, 
    ...
    category5, state, country, bank_beneficiary, agent, commission_account, parent, gst_tax, tds_nature_of_payment, 
    ...
    execute format('grant insert(name, division, inventory_type, allow_negative_stock, gst_tax, unit, loose_qty, 
    reorder_inventory, bulk_inventory, qty, sale_unit, purchase_unit, cess, purchase_config, 
    ...
    execute format('grant update(name, inventory_type, allow_negative_stock, gst_tax, unit,  
    reorder_inventory, bulk_inventory, qty, sale_unit, purchase_unit, cess, purchase_config, 
    sale_config, barcodes, tags, hsn_code, description, manufacturer, manufacturer_name, vendor, 
    vendor_name, vendors, salts, set_rate_values_via_purchase, apply_s_rate_from_master_for_sale, 
    category1, category2, category3, category4, category5, category6, category7, category8, 
